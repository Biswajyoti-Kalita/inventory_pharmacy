...
const role = 1;
					app.post("/pharmacies/addpurchase_drug",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			purchase_date : req.body.purchase_date,
					...
					app.post("/pharmacies/updatepurchase_drug",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			purchase_date : req.body.purchase_date,
					...
					app.post("/pharmacies/deletepurchase_drug",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/pharmacies/bulkdeletepurchase_drug", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/pharmacies/getpurchase_drugs",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/pharmacies/getpurchase_drug",  roleService.verifyRole(role),  async function(req, res) {
				    try {
