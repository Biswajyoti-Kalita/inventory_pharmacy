...
const role = 0;
					app.post("/admin/addpurchase_return_drug",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			return_date : req.body.return_date,
					...
					app.post("/admin/updatepurchase_return_drug",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			return_date : req.body.return_date,
					...
					app.post("/admin/deletepurchase_return_drug",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/admin/bulkdeletepurchase_return_drug", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/admin/getpurchase_return_drugs",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/admin/getpurchase_return_drug",  roleService.verifyRole(role),  async function(req, res) {
				    try {
