        ...
        $("#orderTableBody").append(`
            ...
            result[i]
              ...
              : " "
					...
					<td>${
            result[i] ? (result[i].status ? result[i].status : " ") : " "
          }</td><td><span class="btn btn-link btn-sm" onclick="editOrderModal(  '${
          result[i].uuid
          ...
          result[i].id
        } )">Edit</span><span class="btn btn-link btn-sm" onclick="deleteOrderModal(${
          result[i].id
        })">Delete</span></td>
				          </tr>
				        `);
